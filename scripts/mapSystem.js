...
function openMapSelection(fromAuction) {
  var rightPanel = document.querySelector('.map-home-right');
  if (rightPanel) rightPanel.style.display = fromAuction ? '' : 'none';
...
function initMapListeners() {
  ...
  document.getElementById('mapOverlay').addEventListener('click', function(e) {
    if (e.target === this) skipMapSelection();
  });
